...
class ArchivesController extends AppController {
    ...
    function file_remove() {
        ...
        foreach ($val as $val) {
            ...
            $cur_data = $this->Easycase->find('first', array('conditions' => array('Easycase.id' => $getFiles['CaseFile']['easycase_id']), 'fields' => array('Easycase.case_no', 'Easycase.project_id')));
            if($cur_data){
                    ...
                    $files = $this->CaseFile->find('all', array('conditions' => array('CaseFile.company_id' => SES_COMP, 'CaseFile.easycase_id' => $org_data)));
                    if (empty($files)) {
