...
<div class="proj_grids glide_div setting_wrapper task_listing resource_sec cmn_tbl_widspace" id="resource_utilization_div">
	...
	<div id="recource_utilization_export_btn" class="logmore-btn btn_tlog_top fr" style="display:none;">
		<a class="btn btn-sm btn_cmn_efect" onclick="ajax_resource_utilization_export_csv();">
			<span aria-hidden="true" class="glyphicon glyphicon-export"></span> Export(.csv)
		</a>
	</div>
    ...
    <table id="grid-keep-selection" class="table table-striped resource-utilize-table m-list-tbl">
        <thead>
            <tr>
                ...
                <th data-column-id="resource" data-identifier="true">Resource</th>
                <th data-column-id="project" data-visible="false">Project</th>
                <th data-column-id="task_title" data-visible="false">Task Title</th>
                <th data-column-id="task_group" data-visible="false">Milestone</th>
                <th data-column-id="task_status" data-visible="false" data-sortable="false">Status</th>
                <th data-column-id="task_type" data-visible="false" data-sortable="false">Type</th>
                <th data-column-id="hours">Hour(s) Spent</th>
                <th data-column-id="esthrs">Estimated Hour(s)</th>
                <th data-column-id="is_billable" data-sortable="false">Billable</th>
            </tr>
        </thead>
    </table>
    </div>
...
<style>
    #dropdown_menu_utilization_status{max-height: 240px;min-width: 175px;overflow-y: auto;padding-left: 12px;}
</style>
<script>
...
function customdatetutilization(){
    $('#custom_utilization').toggle();
	$('#custom_utilization').closest('ul').scrollTop(200);
}
