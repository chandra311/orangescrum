...
<?php  echo $this->Form->create('Project',array('url'=>'/projects/settings','name'=>'projsettings','enctype'=>'multipart/form-data'));  ?>
	...
	<tr>
	    ...
	    <td>
		<?php echo $this->Form->text('name',array('value'=>html_entity_decode(stripslashes($projArr['Project']['name'])),'class'=>'form-control','id'=>'txt_proj','maxlength'=>'100')); ?>
	    </td>
	</tr>
	<tr>
		...
		<?php if(strtoupper($projArr['Project']['short_name']) == 'WCOS'){
			echo $this->Form->text('short_name',array('value'=>stripslashes($projArr['Project']['short_name']),'class'=>'form-control ttu','id'=>'txt_shortProjEdit','maxlength'=>'50','readonly'=>'readonly')); 
		    }else{
			echo $this->Form->text('short_name',array('value'=>stripslashes($projArr['Project']['short_name']),'class'=>'form-control ttu','id'=>'txt_shortProjEdit','maxlength'=>'50'));
		    } ?>
	    </td>
	</tr>
	<tr>
	    ...
	    <td>
		<?php echo $this->Form->text('product_type',array('value'=>html_entity_decode(stripslashes($projArr['Project']['product_type'])),'class'=>'form-control','id'=>'txt_prod','maxlength'=>'100')); ?>
	    </td>
	</tr>
	<tr>
