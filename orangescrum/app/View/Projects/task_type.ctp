...
<div class="impexp_div" style="border:0;margin-top:0;margin-bottom:5px;">
    ...
    <div class="fr"><button class="btn btn_blue" onclick="addNewTaskType();" style="padding: 5px;margin-right: 3px !important;margin-top:60px">+ <?php echo __("New Task Type"); ?></button></div>
    <div class="cb"></div>
</div>
