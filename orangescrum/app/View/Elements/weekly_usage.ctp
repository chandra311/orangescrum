									...
									<div style="text-align:left;">
										<ul>
											...
											<li>
												...
												echo $curr_wk_tot_closed_tasks.'</b> closed out of <b>'.$total_task_cr_current_week.'</b> tasks, <b>'.$hrspnt.'</b> hours spent and <b>'.$curr_wk_tot_storage_usage;?></b> Mb <?php echo __("storage used on all projects"); ?>
											</li>
										</ul>
									</div><br/>
								</div>
