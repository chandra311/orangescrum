...
-->			
 <?php if(defined('CR') && CR == 1 && SES_CLIENT ==1 && $this->Format->get_client_permission('milestone')==1){ 
                ...
                <div class="proj_mng">
					...
					<br /><% } %>
					<a href="javascript:void(0);" class="icon-delete-mlstn fl ellipsis-view" title="<?php echo __('Delete');?>" onClick="delMilestone(this);" data-uid="<%= milestoneUniqId %>" data-name="<%= milestoneTitle %>"><?php echo __('Delete');?></a><br />
					<% if(mlsttype!='0'){ %>
					<a href="javascript:void(0);" class="icon-delete-mlstn fl ellipsis-view" title="<?php echo __('Assign To User');?>" onClick="assignToUser(this);" data-uid="<%= milestoneUniqId %>" data-name="<%= milestoneTitle %>"><?php echo __('Assign To User');?></a>
					<% } %>
				    </div>
				</div>
                                            <?php } ?>
