...
<div class="popup_bg">
    ...
    <div class="recurring_info cmn_popup" style="display: none;" >
        <div class="popup_title">
            <span><?php echo __('Upcoming due dates of this task'); ?></span>
            <a href="javascript:jsVoid();" onclick="closePopup();"><div class="fr close_popup">X</div></a>
        </div>
        <div class="popup_form" id ="recurring_info_id">
            <div class="loader_dv"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..." /></center></div>
        </div>
    </div>
    <!-- Recurring Task popup starts -->
    <div class="recurring_task cmn_popup" style="display: none;">
        <div class="popup_title">
				...
				<tr>
					<td>
						...
						<table cellpadding="0" cellspacing="0" width="100%">
                            <?php if((defined('GNC') && GNC == 1) || (defined('GTLG') && GTLG == 1)) { ?>
                            <tr>
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <div class="rht-con">
                                                    <a href="javascript:;">
                                                        <input type="text" id="gantt_start_date" onkeyup="$(this).val('');" name="data[Easycase][gantt_start_date]" class="form-control" style="width:190px;" value="<?php if(isset($taskdetails['gantt_start_date']) && $taskdetails['gantt_start_date']){echo $taskdetails['gantt_start_date'];}?>"/>
                                                    </a>
                                                </div>
                                            ...
                                            <td style="">
                                                <div class="rht-con">
                                                    <a rel="tooltip" href="javascript:;" original-title="<?php echo __("You can enter time as 1.5 (that  mean 1 hour and 30 minutes)"); ?>.">
                                                        <input type="text" onkeypress="return numericDecimal(event)" onkeyup="changeDate()" id="estimated_hours" name="data[Easycase][estimated_hours]" maxlength="6" class="form-control" style="width:190px;" value="<?php if(isset($taskdetails['estimated_hours']) && $taskdetails['estimated_hours']){echo $taskdetails['estimated_hours'];}?>"/>
                                                    </a>
                                                </div>
                                                <div class="clearfix"></div>
                                            </td>
										...
										<div class="fl dropdown option-toggle p-6">
											...
											<div class="more_opt" id="more_opt3" >
												<ul>
													...
													<li><a href="javascript:jsVoid()">&nbsp;&nbsp;<?php echo __("Today"); ?><span class="value"><?php echo date('M j, D',strtotime($userDate));?></span> </a></li> 	
													...
													<li style="color:#808080; padding-left:10px;">
														<input type="hidden" id="due_date" title="<?php echo __('Custom Date'); ?>" style="min-width:30px;"/>&nbsp;<span style="position:relative;"><?php echo __("Custom Date"); ?></span>
													</li>
												</ul>
											</div>
										</div>
				...
				<?php /* <tr>
					<td colspan="2" align="left">
						...
						<div class="col-lg-9 fl rht-con rht_bg" style="padding-left:4px; padding-bottom:0">
							<div class="fr mor_toggle tasktoogle" id="more_tsk_opt_div" style="position: relative;float:left"><a href="javascript:jsVoid();" onclick="opencase('click');" style="text-decoration:none"><img src="<?php echo HTTP_IMAGES;?>description.png" title="<?php echo __('Description'); ?>" rel="tooltip"/>&nbsp;&nbsp;<img src="<?php echo HTTP_IMAGES;?>hours.png" title="<?php echo __('Estimated Hours and Hours Spent'); ?>" rel="tooltip"/>&nbsp;&nbsp;<img src="<?php echo HTTP_IMAGES;?>attachment.png" title="<?php echo __('Attachments, Google Drive, Dropbox'); ?>" rel="tooltip"/>&nbsp;&nbsp;<?php echo __("More Options"); ?><b class="caret"></b></a></div>

							<div class="fr less_toggle tasktoogle" id="less_tsk_opt_div" style="display:none;position: relative;float:left"><a href="javascript:jsVoid();" onclick="closecase();"  style="text-decoration:none"><?php echo __('Less'); ?><b class="caret"></b></a></div>
