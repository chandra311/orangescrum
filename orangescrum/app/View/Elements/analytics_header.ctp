<style>
.tab.tab_comon .nav-tabs li {min-width:110px;}
</style>
<div class="tab tab_comon">
	<ul class="nav-tabs mod_wide">
        ...
        <li <?php if(CONTROLLER == "reports" && (PAGE_NAME == "chart")) { ?>class="active"<?php } ?>>
			...
			<div class="fl"><?php echo __("Task Reports"); ?></div>
			<div class="cbt"></div>
			</a>
		</li>
		<li <?php if(CONTROLLER == "reports" && (PAGE_NAME == "hours_report")) { ?>class="active"<?php } ?>>
			...
			<div class="fl"><?php echo __("Hour Spent"); ?></div>
			<div class="cbt"></div>
			</a>
		</li>
		<?php if(SES_TYPE == 1 || SES_TYPE == 2) { ?>
			<li <?php if(CONTROLLER == "reports" && (PAGE_NAME == "weeklyusage_report")) { ?>class="active"<?php } ?>>
				...
				<div class="fl"><?php echo __("Weekly Usage"); ?></div>
				<div class="cbt"></div>
				</a>
			</li>
            <?php if(defined('TLG') && TLG == 1){ ?>
                <li <?php if(CONTROLLER == "LogTimes" && (PAGE_NAME == "resource_utilization")) { ?>class="active"<?php } ?>>
                    ...
                    <div class="an_week fl"></div>
                    <div class="fl"><?php echo __("Resource Utilization"); ?></div>
                    <div class="cbt"></div>
                    </a>
                </li>
